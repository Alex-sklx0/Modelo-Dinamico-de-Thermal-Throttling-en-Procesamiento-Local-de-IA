...
$R_{\text{obj}}$  & 40\,ops/s (norm.)     & Throughput objetivo del gobernador \\
...
Latencia intrínseca  & $\delta_0$ & $16$ & Overhead del SO, calibrado para $P^*$ entre 15-45 W \\
...
\begin{notacal}
Los factores $\gamma_0$ y $\delta_0$ se calibraron iterativamente hasta
que $P^* = \delta \cdot R_{\text{obj}}/\gamma \approx 47.6$\,W cayera en el rango
físico esperado (15--45\,W bajo carga para un procesador de 8 núcleos).
$\delta_0=16$ produce $\delta=1.0$ con los buses de referencia.
\end{notacal}
